                ...
                if(Factions::isSpawnRegion($player)) {
                    ...
                    switch($event->getItem()->getID()){
                        ...
                        case ItemIds::COAL:
                            ...
                            $player->sendMessage(str_replace(["&", "{currentEnergy}", "{needEnergy}", "{effect}"], ["§", $player->getMageEnergy(), $player->getMageEnergyCost($event->getItem()->getId()), "Weakness"], Loader::getConfiguration("messages")->get("mage_use_spell")));
                            $player->setMageEnergy($player->getMageEnergy() - $player->getMageEnergyCost($event->getItem()->getId()));
                            $event->getItem()->setCount($event->getItem()->getCount() - 1);
                            $player->getInventory()->setItemInHand($event->getItem()->getCount() > 0 ? $event->getItem() : Item::get(Item::AIR));
                            foreach(Loader::getInstance()->getServer()->getOnlinePlayers() as $onlinePlayer){
                        ...
                        case ItemIds::ROTTEN_FLESH:
                            ...
                            $player->sendMessage(str_replace(["&", "{currentEnergy}", "{needEnergy}", "{effect}"], ["§", $player->getMageEnergy(), $player->getMageEnergyCost($event->getItem()->getId()), "Hunger"], Loader::getConfiguration("messages")->get("mage_use_spell")));
                            $player->setMageEnergy($player->getMageEnergy() - $player->getMageEnergyCost($event->getItem()->getId()));
                            $event->getItem()->setCount($event->getItem()->getCount() - 1);
                            $player->getInventory()->setItemInHand($event->getItem()->getCount() > 0 ? $event->getItem() : Item::get(Item::AIR));
                            foreach(Loader::getInstance()->getServer()->getOnlinePlayers() as $onlinePlayer){
                        ...
                        case ItemIds::DYE:
                            ...
                            $player->sendMessage(str_replace(["&", "{currentEnergy}", "{needEnergy}","{effect}"], ["§", $player->getMageEnergy(), $player->getMageEnergyCost($event->getItem()->getId()), "Poison"], Loader::getConfiguration("messages")->get("mage_use_spell")));
                            $player->setMageEnergy($player->getMageEnergy() - $player->getMageEnergyCost($event->getItem()->getId()));
                            $event->getItem()->setCount($event->getItem()->getCount() - 1);
                            $player->getInventory()->setItemInHand($event->getItem()->getCount() > 0 ? $event->getItem() : Item::get(Item::AIR));
                            foreach(Loader::getInstance()->getServer()->getOnlinePlayers() as $onlinePlayer){
                        ...
                        case ItemIds::SEEDS:
                            ...
                            $player->sendMessage(str_replace(["&", "{currentEnergy}", "{needEnergy}", "{effect}"], ["§", $player->getMageEnergy(), $player->getMageEnergyCost($event->getItem()->getId()), "Nausea"], Loader::getConfiguration("messages")->get("mage_use_spell")));
                            $player->setMageEnergy($player->getMageEnergy() - $player->getMageEnergyCost($event->getItem()->getId()));
                            $event->getItem()->setCount($event->getItem()->getCount() - 1);
                            $player->getInventory()->setItemInHand($event->getItem()->getCount() > 0 ? $event->getItem() : Item::get(Item::AIR));
                            foreach(Loader::getInstance()->getServer()->getOnlinePlayers() as $onlinePlayer){
                        ...
                        case ItemIds::GOLD_NUGGET:
                            ...
                            $player->sendMessage(str_replace(["&", "{currentEnergy}", "{needEnergy}", "{effect}"], ["§", $player->getMageEnergy(), $player->getMageEnergyCost($event->getItem()->getId()), "Slowness"], Loader::getConfiguration("messages")->get("mage_use_spell")));
                            $player->setMageEnergy($player->getMageEnergy() - $player->getMageEnergyCost($event->getItem()->getId()));
                            $event->getItem()->setCount($event->getItem()->getCount() - 1);
                            $player->getInventory()->setItemInHand($event->getItem()->getCount() > 0 ? $event->getItem() : Item::get(Item::AIR));
                            foreach(Loader::getInstance()->getServer()->getOnlinePlayers() as $onlinePlayer){
