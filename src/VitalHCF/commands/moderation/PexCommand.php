...
class PexCommand extends PluginCommand {
	...
	protected $listRanks = ["Guest", "Owner", "Admin", "Jr-Admin", "Sr-Admin", "Mod", "T-Mod", "Sr-Mod", "Partner", "MiniYT", "YouTuber", "Famous", "Soul", "Demon", "Averno", "Ember", "System", "Streamer", "Developer", "Trainee", "Co-Owner", "NitroBooster", "Mild"];
